...
import company.vk.edu.distrib.compute.dkoften.kafka.AuditableKVServiceFactory;
import company.vk.edu.distrib.compute.dkoften.kafka.AuditServiceFactoryImpl;
...
public class AuditServiceFactoryArgumentsProvider implements ArgumentsProvider {
    private final Set<ImmutablePair<Class<? extends KVServiceFactory>, Class<? extends AuditServiceFactory>>>
            factories = Set.of(
            ImmutablePair.of(AuditableKVServiceFactory.class, AuditServiceFactoryImpl.class)
    );
